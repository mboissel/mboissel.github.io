...
- <i class="fa fa-linkedin" style="color: #4169e1;"></i> [linkedin.com/in/FBoissel](https://www.linkedin.com/in/FBoissel)
- <i class="fa fa-github" style="color: #4169e1;"></i> [github.com/FBoissel](https://github.com/FBoissel)
- <i class="fa fa-twitter" style="color: #4169e1;"></i> [twitter.com/FBoissel](https://twitter.com/FBoissel)
