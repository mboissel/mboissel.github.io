...
- <i class="fa fa-user" style="color: #00CED1;"></i> Biostatistician
- <i class="fa fa-university" style="color: #00CED1;"></i> UMR8199/1283 Functional (Epi)genomics and Mechanisms of Type 2 Diabetes and Related Diseases
...
- <u style="color: #00CED1;">*Advanced:*</u> R, Data Analysis, Visualisation, Git 
- <u style="color: #00CED1;">*Intermediate:*</u> Docker, vcftools, Plink, SQL, POO Python, Perl
- <u style="color: #00CED1;">*Basic:*</u> Bash, MongoDB, SAS, VBA
...
With a master’s degree in **Applied Mathematics and Statistics**, I like projects with mental challenges, precision and team work. I have skills in programming and statistical methods, with a solid educational foundation and a passion for data science.

## Professional & Research Experience {data-icon=laptop}

### Biostatistician Engineer

UMR8199 - University of Lille & CNRS

Lille, France

10/2015 - Today

Activities: *Statistical studies in genomic, diabete and obesity field*

* Analyses : Methodological support, ANOVA, Modeling (GLM, Mixte model), Classification, Selection (variables or models), ACP/t-SNE, Machine Learning and cross validation, Scoring.
* Handling omics data: DNA microarray, Methylation chip and Next-Generation Sequencing (DNA, RNAseq)
* Omics analyses: GWAS, EWAS, TWAS (DE analyses), eQTL, mQTL, eQTM, Rare variant analyses (burden and dispersion test) 
* Use of various Data Base : 1000 genomes, Ensembl, dbNSFP, COSMIC, DAVID. Technology : SQL, MongoDB, Arrow.
...
* Interactive decision-making support (developped with Drupal, WAMP, HTML, PHP)
...
### Co-Founder of Lille UserR Group
...
::: aside
[<i class="fa fa-github"></i>Info](https://rlille.fr/posts/2020-01-31-rlille-welcome/)
:::
...
```{r mybiblio, results = "asis", eval = FALSE, echo = FALSE, message = FALSE, error = FALSE, warning = FALSE}
...
# sub_article <- articles ## my selection = all article
...
format_bib(bib = sub_article, author = "Mathilde Boissel", max = 4, output = "resume")
```
...
Martial art (Karv-Maga, 2y Karaté, 2y Jujitsu, 6y Judo), sports needing rigor, respect and humility
...
European big cities, Photos, Moto bike, Hike
...
Steering committee in a UseR group under construction at Lille; Steering committee in the CNRS working group RIS Statistics and Genomics; "Fête De la Science" at Lille; 
