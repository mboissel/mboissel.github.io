...
* GWAS, EWAS, eQTL, mQTL, Differential expression analyses, Rare variant analyses (burden and dispersion test) 
* Statistical modelling, Clustering methods, Methodological support
* Handling and formatting data from DNA microarray, Methylation chip or Next-Generation Sequencing, with large sample sizes
* Use of various databases : 1000 genomes, Ensembl, dbNSFP, COSMIC, DAVID
...
* Modelling a recommendation system (combination of survival probabilities and patient ratings on their expectations concerning quality of life and iatrogenic effects of the treatment)
* Model tested by simulating its self-learning nature and sensitivity
* Development of an interactive decision-making support (with Drupal, use of a WAMP, HTML, PHP and JS)
* Introduction to data managment (Clinsight, eCRF, coherence test and CDISC)
...
* Use of R, Statistica and SAS, Methodological support for thesis students in biology
...
### Baccalauréat (equivalent A levels) Scientific
